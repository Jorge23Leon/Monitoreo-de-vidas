...
interface LocalAgroUnitDao {
    ...
    @Query("SELECT * FROM local_agro_units WHERE idLocalCia = :idLocalCia ORDER BY commercial_name ASC")
    suspend fun getAgroUnitsByCia(idLocalCia: Long): List<LocalAgroUnitEntity>
}